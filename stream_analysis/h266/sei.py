"""H.266 SEI (Supplemental Enhancement Information) message parser.

Follows ITU-T H.266 Section 7.3.5.
Same framing as H.264/H.265 SEI (payload_type/size accumulated from 0xFF bytes).
"""
...
SEI_PAYLOAD_TYPE_NAMES = {
    ...
    181: "ambient_viewing_environment",
    200: "subpicture_level_info",
    201: "sample_aspect_ratio_info",
}
